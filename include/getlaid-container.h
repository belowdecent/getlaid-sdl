 ...
 *
 * Two-dimensional container consisting of main and cross axes, akin to CSS Flexbox
 */
...
typedef enum GTLD_Direction {
  GTLD_ROW, /**< Main axis - horizontal, cross axis - vertical */
  GTLD_COLUMN, /**< Main axis - vertical, cross axis - horizontal */
} GTLD_Direction;
...
typedef struct GTLD_Container {
  GTLD_Direction direction; /**< Container growth direction */
  GTLD_Repeat repeat; /**< /todo make it a GTLD_Axis property */

  GTLD_Axis main; /**< main axis */
  GTLD_Axis cross; /**< cross axis */
} GTLD_Container;

/** Helper macro to create containers where children are equally aligned */
