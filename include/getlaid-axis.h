...
typedef enum GTLD_Alignment {
  /** Pack items from the start, similar to `align-items: start` in CSS */
  GTLD_ALIGN_BEGIN,
  /** Pack items around the center, similar to `align-items: center` in CSS */
  GTLD_ALIGN_CENTER,
  /** Pack items from the end, similar to `align-items: end` in CSS */
  GTLD_ALIGN_END
} GTLD_Alignment;


/**
 * Struct for defining layouts along one of the axes in container
 *
 * \see GTLD_Alignment
 * \see GTLD_Unit
 */
typedef struct GTLD_Axis {
  ...
  /** Array of GTLD_Units that define the element sizes along this axis */
